              ...
              <form class="form-signin">
                <div v-if="showwatch == 'login'">
                  ...
                  <div class="row social-login" v-if="hasfb">
                    <div class="col mb-4">
                      <button type="button" v-if="hasfb" class="fblogin btn-sm" @click="fblogin">
                        Continuar com o Facebook
                        <span class="icon-form" title="Nome">
                  ...
                  <div class="row wrapper_login">
                    <div class="col mt-3">
                      ...
                      <input
                        ...
                        required
                        autofocus
                        v-bind:class="{ errorinputuser: (!validateinfo.login), 'form-control': true }"
                      />
                    </div>
                  </div>
                  <div class="row wrapper_login">
                    <div class="col mt-2">
                      ...
                      <input
                        ...
                        placeholder="Senha"
                        required
                        v-bind:class="{ errorinputuser: (!validateinfo.pass), 'form-control': true }"
                      />
                    </div>
                  </div>
                  <h4>Favor Renovar sua senha clicando em “esqueceu sua senha” ou renove seu cadastro em “cadastra-se”</h4>
                  <div class="row mt-3">
                    <div class="col mt-4">
  ...
  methods: {
        ...
        function(response) {
          if (response.authResponse) {
            if (
              ...
              ctx.toastError(
                "Facebook: Necessário ter a permissão para recuperar o e-mail do usuário, por favor clique em entrar novamente e dê a permissão correta."
              );
    ...
    makeLogin() {
      ...
      if (this.form.login == "" || this.form.pass == "") {
        ...
        if (this.form.login == "") this.validateinfo.login = false;
        if (this.form.pass == "") this.validateinfo.pass = false;
