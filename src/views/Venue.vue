                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-12 col-lg-8 text-center">
                    ...
                    <div>
                      ...
                      <p class="mt-3 pb-4 lead"></p>
                      <p class="mt-3 pb-4 lead"></p>



                    <a :href="this.event.gotouri" v-if="this.dates.length > 0" class="btn to-btn dark" style="background: #ca1835 !important; border: none !important; font-weight: bold"><i class="fa fa-sm mr-2 fa-running"></i>Site do teatro</a>


                      <h3 class="mt-3 pb-4">Detalhes do evento</h3>

                      <p class="lead mt-0 pt-0 col-6">
                        <span class="event__description mt-0 p-0 text-left mt-2 pt-2">

Bilheteria
Terça a domingo das 15h até o início do espetáculo. | Nos dias que não houver espetáculos a bilheteria funciona até às 19h.
                        </span>
                      </p>
