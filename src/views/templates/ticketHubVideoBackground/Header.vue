...
<div class="a">
      ...
      <div class="container">
        <nav class="navbar navbar-expand-md no-gutters">
          ...
          <ul class="navbar-nav col-2 justify-content-end d-none d-md-flex">
            <span v-if="!isLogged" class="btn btn-sm btn-light to-btn header__signin hidden-xs hidden-sm" @click="login">Entrar</span>
  ...
  <b-navbar class="header__mobile" type="dark" variant="dark">
    ...
    <div class="col-3">
      <div class="icon"></div>
      <span v-if="!isLogged" class="btn   btn-light to-btn header__signin hidden-xs hidden-sm" @click="login">Entrar</span>
      <span v-if="!isLogged" class="header__signin-mobile" @click="login"><img src="" alt=""></span>
