    ...
    <div>
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <section
              class="to-block bg__ingressaria to-block-mobile mt-0 pt-1"
                ...
                <div class="row">
                  <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <div v-else>
                      ...
                      <span class="event__badges">
                        <a
                          href="#"
                          class="badge badge__icon badge__genre badge-danger noClick"
                          id="badge__gender"
                        ...
                        <a
                          ...
                          href="#"
                          class="badge badge__icon badge__money badge-success noClick"
                          id="badge__price"
                        >{{event.valores}}</a>
                        <a
                          href="#"
                          class="badge badge__icon badge__partner badge-info noClick"
                      ...
                      <p
                        ...
                        ref="eventdesc"
                      >
                        <span class="event__description mt-0 p-0" v-html="event.description"></span>
                      </p>
                      <div
                        id="read-more"
                      ...
                      >
                        <div class="btn to-btn dark">LER MAIS</div>
                      </div>
                      <div
                        id="read-less"
                        @click="showreadmoreclick"
                        v-if="showreadandless && !showreadmore"
                      >
                        <div class="btn to-btn dark">LER MENOS</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6 mx-auto col-md-4 col-lg-6">
                    <EventImageIngressariaLoader
                      ...
                      :speed="2"
                      :animate="true"
                      style="height: 240px; border-radius: 5px; box-shadow: none!important"
                    ></EventImageIngressariaLoader>
                      ...
                      >
                        <div class="c">
                          ...
                          <div
                            ...
                            v-bind:class="{'card__time-active':selected == undefined ? selected = item.id_apresentacao : item.id_apresentacao == selected}"
                          >
                            <div>
                              <h3
                                v-if="item.istoday == 1"
