        ...
        <div class="col-md-12" style="">
          ...
          <div class="content__description">
            ...
            <EventImageLoader class="event__card-img"  v-if="!imageLoaded && !roomLoaded && !timeLoaded" :speed="2" :animate="true" style="height: 200px; border-radius: 5px"></EventImageLoader>
                <img v-else class="event__card-img" :src="event.img" alt=""
                  style="">
            ...
            <div class="time__placeholder" v-else>
                ...
                <div class="card" v-for="(item, index) in filtered" :key='index'>
                    ...
                    <div class="col-7 col-md-7 card__description">
                        {{ item.NomPeca }} - {{item.NomSala}} - {{ item.ValPeca | money}} <br>
                        {{ item.ds_municipio }}
                    </div>
...
.badge-prL[href]:hover, .badge-prL[href]:focus {
  color: #fff;
...
.badge-pr10[href]:hover, .badge-pr10[href]:focus {
  color: #fff;
  text-decoration: none;
...
.badge-pr12[href]:hover, .badge-pr12[href]:focus {
  color: #212529;
  text-decoration: none;
...
.badge-pr14[href]:hover, .badge-pr14[href]:focus {
  color: #fff;
  text-decoration: none;
...
.badge-pr16[href]:hover, .badge-pr16[href]:focus {
  color: #fff;
  text-decoration: none;
...
.badge-pr18[href]:hover, .badge-pr18[href]:focus {
  color: #fff;
  text-decoration: none;
